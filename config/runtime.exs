...
#
#     PHX_SERVER=true bin/ee_web_archive start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ee_web_archive, EEWebArchiveWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ee_web_archive, EEWebArchiveWeb.Endpoint,
    url: [host: "new.offlinee.com", port: port, scheme: "https"],
    http: [
  ...
  #
  #     config :ee_web_archive, EEWebArchive.Mailer,
